...
public class C6871c extends KeyFactorySpi implements Rg.a {
    @Override // Rg.a
    public PrivateKey a(Cg.b bVar) {
        return new C6869a(bVar);
    }

    @Override // Rg.a
    public PublicKey b(Dg.b bVar) {
        return new C6870b(bVar);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof C6869a) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else {
            if (!(key instanceof C6870b)) {
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof C6869a) || (key instanceof C6870b)) {
            return key;
        }
