...
public class N {
    ...
    private final Bundle f43348a;

    public N(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f43348a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f43348a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f43348a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f43348a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f43348a);
        for (String str : this.f43348a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
