...
public class AttributionHandler implements IAttributionHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class c implements Runnable {
        ...
        public final /* synthetic */ SessionResponseData f34013a;

        public c(SessionResponseData sessionResponseData) {
            this.f34013a = sessionResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkSessionResponseI(iActivityHandler, this.f34013a);
        }
    }
    ...
    public class d implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ SdkClickResponseData f34015a;

        public d(SdkClickResponseData sdkClickResponseData) {
            this.f34015a = sdkClickResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkSdkClickResponseI(iActivityHandler, this.f34015a);
        }
    }
    ...
    public class e implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ AttributionResponseData f34017a;

        public e(AttributionResponseData attributionResponseData) {
            this.f34017a = attributionResponseData;
        }
        ...
        public final void run() {
            ...
            AttributionHandler.this.checkAttributionResponseI(iActivityHandler, this.f34017a);
        }
    }
    ...
    public class g implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ResponseData f34020a;

        public g(ResponseData responseData) {
            this.f34020a = responseData;
        }
        ...
        public final void run() {
            ...
            ResponseData responseData = this.f34020a;
