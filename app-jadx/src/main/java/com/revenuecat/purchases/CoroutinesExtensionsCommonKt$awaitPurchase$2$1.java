...
public final class CoroutinesExtensionsCommonKt$awaitPurchase$2$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ Zd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsCommonKt$awaitPurchase$2$1(Zd.e eVar) {
        super(2);
    ...
    public final void invoke(StoreTransaction storeTransaction, CustomerInfo customerInfo) {
        ...
        u.a aVar = u.f17466b;
        eVar.resumeWith(u.b(new PurchaseResult(storeTransaction, customerInfo)));
    }
}
