...
public final class PurchasesOrchestrator$setDisplayName$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ LogIntent $intent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PurchasesOrchestrator$setDisplayName$$inlined$log$1(LogIntent logIntent) {
        super(0);
