...
public final class PurchasesOrchestrator$setSolarEngineDistinctId$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(AttributionStrings.METHOD_CALLED, Arrays.copyOf(new Object[]{"setSolarEngineDistinctId"}, 1));
