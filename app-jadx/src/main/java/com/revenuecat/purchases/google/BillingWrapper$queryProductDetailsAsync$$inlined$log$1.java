...
public final class BillingWrapper$queryProductDetailsAsync$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(OfferingStrings.FETCHING_PRODUCTS, Arrays.copyOf(new Object[]{AbstractC2279u.w0(this.$productIds$inlined, null, null, null, 0, null, null, 63, null)}, 1));
