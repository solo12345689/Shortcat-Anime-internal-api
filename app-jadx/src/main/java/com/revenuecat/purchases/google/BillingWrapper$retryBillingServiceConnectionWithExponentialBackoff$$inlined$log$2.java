...
public final class BillingWrapper$retryBillingServiceConnectionWithExponentialBackoff$$inlined$log$2 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(BillingStrings.BILLING_CLIENT_RETRY, Arrays.copyOf(new Object[]{Long.valueOf(this.this$0.reconnectMilliseconds)}, 1));
