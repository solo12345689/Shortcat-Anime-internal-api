...
public final /* data */ class QueryPurchaseHistoryUseCaseParams implements UseCaseParams {
    ...
    public QueryPurchaseHistoryUseCaseParams(DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, String productType, boolean z10) {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC5504s.c(this.dateProvider, queryPurchaseHistoryUseCaseParams.dateProvider) && AbstractC5504s.c(this.diagnosticsTrackerIfEnabled, queryPurchaseHistoryUseCaseParams.diagnosticsTrackerIfEnabled) && AbstractC5504s.c(this.productType, queryPurchaseHistoryUseCaseParams.productType) && this.appInBackground == queryPurchaseHistoryUseCaseParams.appInBackground;
    }
    ...
    public int hashCode() {
        ...
        return ((((iHashCode + (diagnosticsTracker == null ? 0 : diagnosticsTracker.hashCode())) * 31) + this.productType.hashCode()) * 31) + Boolean.hashCode(this.appInBackground);
    }
    ...
    public /* synthetic */ QueryPurchaseHistoryUseCaseParams(DateProvider dateProvider, DiagnosticsTracker diagnosticsTracker, String str, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
