...
public final class GetBillingConfigUseCase$executeAsync$1$invoke$lambda$1$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ LogIntent $intent;
    final /* synthetic */ C3160e $result$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GetBillingConfigUseCase$executeAsync$1$invoke$lambda$1$$inlined$log$1(LogIntent logIntent, C3160e c3160e) {
        super(0);
        this.$intent = logIntent;
        this.$result$inlined = c3160e;
    }
