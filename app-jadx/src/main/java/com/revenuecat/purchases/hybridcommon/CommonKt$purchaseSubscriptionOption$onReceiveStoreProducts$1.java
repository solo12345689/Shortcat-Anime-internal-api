...
final class CommonKt$purchaseSubscriptionOption$onReceiveStoreProducts$1 extends AbstractC5506u implements Function1 {
    ...
    /* JADX INFO: renamed from: com.revenuecat.purchases.hybridcommon.CommonKt$purchaseSubscriptionOption$onReceiveStoreProducts$1$10, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-a27a03ecaa04c3f144355334beb55c9cbfc36dda79e554423bceb24cf939fcb7 */
    ...
    static final class AnonymousClass10 extends AbstractC5506u implements Function1 {
        final /* synthetic */ List<Map<String, Object>> $addOnPackages;
        final /* synthetic */ OnResult $onResult;
        final /* synthetic */ Map<String, Object> $presentedOfferingContext;
        ...
        AnonymousClass10(Map<String, ? extends Object> map, OnResult onResult, List<? extends Map<String, ? extends Object>> list, PurchaseParams.Builder builder) {
            super(1);
    ...
    /* JADX INFO: renamed from: com.revenuecat.purchases.hybridcommon.CommonKt$purchaseSubscriptionOption$onReceiveStoreProducts$1$9, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-a27a03ecaa04c3f144355334beb55c9cbfc36dda79e554423bceb24cf939fcb7 */
    ...
    static final class AnonymousClass9 extends AbstractC5506u implements Function1 {
        final /* synthetic */ OnResult $onResult;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass9(OnResult onResult) {
            super(1);
            this.$onResult = onResult;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    CommonKt$purchaseSubscriptionOption$onReceiveStoreProducts$1(String str, String str2, Activity activity, Map<String, ? extends Object> map, String str3, Boolean bool, List<? extends Map<String, ? extends Object>> list, List<? extends Map<String, ? extends Object>> list2, List<? extends Map<String, ? extends Object>> list3, OnResult onResult, GoogleReplacementMode googleReplacementMode) {
        super(1);
    ...
    public final void invoke(List<? extends StoreProduct> storeProducts) {
        ...
        if (list2 == null || list2.isEmpty()) {
            ...
            ListenerConversionsCommonKt.getOfferingsWith(Purchases.INSTANCE.getSharedInstance(), new AnonymousClass9(this.$onResult), new AnonymousClass10(this.$presentedOfferingContext, this.$onResult, this.$addOnPackages, builder));
        }
    }
}
