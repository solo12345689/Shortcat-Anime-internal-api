...
final class CommonKt$setAppstackAttributionParams$1$onSuccess$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ OnResult $onResult;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CommonKt$setAppstackAttributionParams$1$onSuccess$1(OnResult onResult) {
        super(1);
