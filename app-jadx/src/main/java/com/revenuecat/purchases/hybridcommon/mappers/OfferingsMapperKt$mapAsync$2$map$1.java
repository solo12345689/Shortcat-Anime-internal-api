...
final class OfferingsMapperKt$mapAsync$2$map$1 extends l implements Function2 {
    final /* synthetic */ Offering $this_mapAsync;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    OfferingsMapperKt$mapAsync$2$map$1(Offering offering, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o10, e eVar) {
        return ((OfferingsMapperKt$mapAsync$2$map$1) create(o10, eVar)).invokeSuspend(L.f17438a);
    }
