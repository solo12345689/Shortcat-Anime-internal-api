...
public final class DeviceCache$addSuccessfullyPostedToken$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(ReceiptStrings.SAVING_TOKENS_WITH_HASH, Arrays.copyOf(new Object[]{this.$token$inlined, this.$hashedToken$inlined}, 2));
