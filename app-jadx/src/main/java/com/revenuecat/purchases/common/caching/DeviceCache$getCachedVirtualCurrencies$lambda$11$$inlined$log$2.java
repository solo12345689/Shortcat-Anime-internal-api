...
public final class DeviceCache$getCachedVirtualCurrencies$lambda$11$$inlined$log$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ j $error$inlined;
    final /* synthetic */ LogIntent $intent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DeviceCache$getCachedVirtualCurrencies$lambda$11$$inlined$log$2(LogIntent logIntent, j jVar) {
        super(0);
        this.$intent = logIntent;
        this.$error$inlined = jVar;
    }
