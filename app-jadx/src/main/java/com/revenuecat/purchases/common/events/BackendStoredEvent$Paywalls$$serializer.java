...
public final class BackendStoredEvent$Paywalls$$serializer implements E {
    ...
    static {
        ...
        C2337k0 c2337k0 = new C2337k0("paywalls", backendStoredEvent$Paywalls$$serializer, 1);
    ...
    public BackendStoredEvent.Paywalls deserialize(e decoder) {
        ...
        int i10 = 1;
        if (cVarB.p()) {
            paywalls = (BackendEvent.Paywalls) cVarB.e(descriptor2, 0, BackendEvent$Paywalls$$serializer.INSTANCE, null);
        } else {
            boolean z10 = true;
            int i11 = 0;
            paywalls = null;
            while (z10) {
                ...
                if (i12 == -1) {
                    ...
                    paywalls = (BackendEvent.Paywalls) cVarB.e(descriptor2, 0, BackendEvent$Paywalls$$serializer.INSTANCE, paywalls);
                    i11 = 1;
                }
            }
            i10 = i11;
