...
public final class OfferingsFactory$createOfferings$1$invoke$lambda$3$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(OfferingStrings.CANNOT_FIND_PRODUCT_CONFIGURATION_ERROR, Arrays.copyOf(new Object[]{AbstractC2279u.w0(this.$missingProducts$inlined, ", ", null, null, 0, null, null, 62, null)}, 1));
