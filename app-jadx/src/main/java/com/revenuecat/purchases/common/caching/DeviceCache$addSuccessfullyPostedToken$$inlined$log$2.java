...
public final class DeviceCache$addSuccessfullyPostedToken$$inlined$log$2 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(ReceiptStrings.TOKENS_IN_CACHE, Arrays.copyOf(new Object[]{this.$current$inlined.keySet()}, 1));
