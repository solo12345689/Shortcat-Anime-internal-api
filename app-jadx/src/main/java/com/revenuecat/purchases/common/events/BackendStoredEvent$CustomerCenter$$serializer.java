...
public final class BackendStoredEvent$CustomerCenter$$serializer implements E {
    ...
    static {
        ...
        C2337k0 c2337k0 = new C2337k0("customer_center", backendStoredEvent$CustomerCenter$$serializer, 1);
    ...
    public BackendStoredEvent.CustomerCenter deserialize(e decoder) {
        ...
        int i10 = 1;
        if (cVarB.p()) {
            customerCenter = (BackendEvent.CustomerCenter) cVarB.e(descriptor2, 0, BackendEvent$CustomerCenter$$serializer.INSTANCE, null);
        } else {
            boolean z10 = true;
            int i11 = 0;
            customerCenter = null;
            while (z10) {
                ...
                if (i12 == -1) {
                    ...
                    customerCenter = (BackendEvent.CustomerCenter) cVarB.e(descriptor2, 0, BackendEvent$CustomerCenter$$serializer.INSTANCE, customerCenter);
                    i11 = 1;
                }
            }
            i10 = i11;
        ...
        cVarB.c(descriptor2);
        return new BackendStoredEvent.CustomerCenter(i10, customerCenter, null);
    }
    ...
    public void serialize(f encoder, BackendStoredEvent.CustomerCenter value) {
        ...
        BackendStoredEvent.CustomerCenter.write$Self$purchases_defaultsBc8Release(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
