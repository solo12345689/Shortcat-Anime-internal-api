...
final class CoroutinesExtensionsKt$awaitStorefrontLocale$2$2 extends AbstractC5506u implements Function1 {
    final /* synthetic */ Zd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitStorefrontLocale$2$2(Zd.e eVar) {
        super(1);
