...
public final class CoroutinesExtensionsKt$awaitGetVirtualCurrencies$2$2 extends AbstractC5506u implements Function1 {
    final /* synthetic */ Zd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitGetVirtualCurrencies$2$2(Zd.e eVar) {
        super(1);
    ...
    public final void invoke(VirtualCurrencies it) {
        ...
        this.$continuation.resumeWith(u.b(it));
    }
}
