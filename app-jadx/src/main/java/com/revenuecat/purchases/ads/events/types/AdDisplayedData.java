...
public final class AdDisplayedData {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC5504s.c(this.networkName, adDisplayedData.networkName) && AdMediatorName.m196equalsimpl0(this.mediatorName, adDisplayedData.mediatorName) && AdFormat.m179equalsimpl0(this.adFormat, adDisplayedData.adFormat) && AbstractC5504s.c(this.placement, adDisplayedData.placement) && AbstractC5504s.c(this.adUnitId, adDisplayedData.adUnitId) && AbstractC5504s.c(this.impressionId, adDisplayedData.impressionId);
    }
    ...
    public String toString() {
        return "AdDisplayedData(networkName=" + this.networkName + ", mediatorName=" + ((Object) AdMediatorName.m198toStringimpl(this.mediatorName)) + ", adFormat=" + ((Object) AdFormat.m181toStringimpl(this.adFormat)) + ", placement=" + this.placement + ", adUnitId=" + this.adUnitId + ", impressionId=" + this.impressionId + ')';
    }
