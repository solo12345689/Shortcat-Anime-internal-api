...
public final class PurchasesOrchestrator$restorePurchases$4$1$3$1$2$invoke$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(RestoreStrings.RESTORING_PURCHASE_ERROR, Arrays.copyOf(new Object[]{this.$purchase$inlined, this.$error$inlined}, 2));
