...
final class AmazonBilling$getMissingSkusForReceipts$1$2 extends AbstractC5506u implements Function1 {
    ...
    AmazonBilling$getMissingSkusForReceipts$1$2(Map<String, PurchasesError> map, Receipt receipt, L l10, Function2 function2, Map<String, String> map2) {
        super(1);
        this.$errorMap = map;
