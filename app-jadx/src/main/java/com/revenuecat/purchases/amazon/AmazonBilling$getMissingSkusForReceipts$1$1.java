...
final class AmazonBilling$getMissingSkusForReceipts$1$1 extends AbstractC5506u implements Function1 {
    ...
    AmazonBilling$getMissingSkusForReceipts$1$1(Map<String, String> map, Receipt receipt, L l10, AmazonBilling amazonBilling, Function2 function2, Map<String, PurchasesError> map2) {
        super(1);
        this.$successMap = map;
