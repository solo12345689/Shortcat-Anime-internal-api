...
final class PaywallComponentSerializer$descriptor$1 extends AbstractC5506u implements Function1 {
    ...
    public final void invoke(a buildClassSerialDescriptor) {
        ...
        a.b(buildClassSerialDescriptor, "type", Sf.a.F(U.f52264a).getDescriptor(), null, false, 12, null);
    }
}
