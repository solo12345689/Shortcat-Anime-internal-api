...
public final class SizeConstraint$Fixed$$serializer implements E {
    ...
    static {
        ...
        C2337k0 c2337k0 = new C2337k0("com.revenuecat.purchases.paywalls.components.properties.SizeConstraint.Fixed", sizeConstraint$Fixed$$serializer, 1);
    ...
    public SizeConstraint.Fixed deserialize(e decoder) {
        ...
        int i10 = 1;
        if (cVarB.p()) {
            d10 = (D) cVarB.e(descriptor2, 0, H0.f20139a, null);
        } else {
            boolean z10 = true;
            int i11 = 0;
            d10 = null;
            while (z10) {
                ...
                if (i12 == -1) {
                    ...
                    d10 = (D) cVarB.e(descriptor2, 0, H0.f20139a, d10);
                    i11 = 1;
                }
            }
            i10 = i11;
        ...
        cVarB.c(descriptor2);
        return new SizeConstraint.Fixed(i10, d10, null, null);
    }
    ...
    public void serialize(f encoder, SizeConstraint.Fixed value) {
        ...
        dVarB.m(descriptor2, 0, H0.f20139a, D.a(value.value));
        dVarB.c(descriptor2);
    }
