...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u0007\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005HÖ\u0001¢\u0006\u0004\b\u0007\u0010\bJ\u0018\u0010\u000b\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\u000b\u0010\fJ \u0010\u0011\u001a\u00020\u00102\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u0002HÖ\u0001¢\u0006\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0016\u001a\u00020\u00138VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0015¨\u0006\u0017"}, d2 = {"com/revenuecat/purchases/paywalls/components/properties/Badge.$serializer", "LVf/E;", "Lcom/revenuecat/purchases/paywalls/components/properties/Badge;", "<init>", "()V", "", "LRf/b;", "childSerializers", "()[LRf/b;", "LUf/e;", "decoder", "deserialize", "(LUf/e;)Lcom/revenuecat/purchases/paywalls/components/properties/Badge;", "LUf/f;", "encoder", "value", "LTd/L;", "serialize", "(LUf/f;Lcom/revenuecat/purchases/paywalls/components/properties/Badge;)V", "LTf/e;", "getDescriptor", "()LTf/e;", "descriptor", "purchases_defaultsBc8Release"}, k = 1, mv = {1, 8, 0}, xi = 48)
@InterfaceC2154e
public final class Badge$$serializer implements E {
    ...
    static {
        ...
        C2337k0 c2337k0 = new C2337k0("com.revenuecat.purchases.paywalls.components.properties.Badge", badge$$serializer, 3);
    ...
    public Badge deserialize(e decoder) {
        ...
        if (cVarB.p()) {
            ...
            Badge.Style style2 = (Badge.Style) cVarB.e(descriptor2, 1, BadgeStyleSerializer.INSTANCE, null);
            stackComponent = stackComponent3;
            twoDimensionalAlignment = (TwoDimensionalAlignment) cVarB.e(descriptor2, 2, TwoDimensionalAlignmentDeserializer.INSTANCE, null);
            style = style2;
            i10 = 7;
        } else {
            boolean z10 = true;
            ...
            while (z10) {
                ...
                if (i12 == -1) {
                    ...
                    style3 = (Badge.Style) cVarB.e(descriptor2, 1, BadgeStyleSerializer.INSTANCE, style3);
                    i11 |= 2;
                } else {
                    if (i12 != 2) {
                        throw new m(i12);
                    }
                    twoDimensionalAlignment2 = (TwoDimensionalAlignment) cVarB.e(descriptor2, 2, TwoDimensionalAlignmentDeserializer.INSTANCE, twoDimensionalAlignment2);
                    i11 |= 4;
                }
            }
            i10 = i11;
        ...
        cVarB.c(descriptor2);
        return new Badge(i10, stackComponent, style, twoDimensionalAlignment, null);
    }
    ...
    public void serialize(f encoder, Badge value) {
        ...
        Badge.write$Self$purchases_defaultsBc8Release(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
