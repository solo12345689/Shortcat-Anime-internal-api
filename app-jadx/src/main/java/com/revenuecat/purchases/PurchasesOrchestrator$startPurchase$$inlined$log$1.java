...
public final class PurchasesOrchestrator$startPurchase$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb3.append(str);
        String str2 = String.format(PurchaseStrings.PURCHASE_STARTED, Arrays.copyOf(new Object[]{sb3.toString()}, 1));
