...
final class CoroutinesExtensionsKt$awaitLogIn$2$2 extends AbstractC5506u implements Function2 {
    final /* synthetic */ Zd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsKt$awaitLogIn$2$2(Zd.e eVar) {
        super(2);
    ...
    public final void invoke(CustomerInfo customerInfo, boolean z10) {
        ...
        u.a aVar = u.f17466b;
        eVar.resumeWith(u.b(new LogInResult(customerInfo, z10)));
    }
}
