...
public final class CoroutinesExtensionsCommonKt$awaitRestore$2$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ Zd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutinesExtensionsCommonKt$awaitRestore$2$1(Zd.e eVar) {
        super(1);
