...
public final class PurchasesOrchestrator$setCreative$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ LogIntent $intent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PurchasesOrchestrator$setCreative$$inlined$log$1(LogIntent logIntent) {
        super(0);
