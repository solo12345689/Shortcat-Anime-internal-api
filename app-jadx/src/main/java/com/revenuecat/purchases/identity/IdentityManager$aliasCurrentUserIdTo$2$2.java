...
final class IdentityManager$aliasCurrentUserIdTo$2$2 extends AbstractC5506u implements Function1 {
    final /* synthetic */ e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    IdentityManager$aliasCurrentUserIdTo$2$2(e eVar) {
        super(1);
    ...
    public final void invoke(PurchasesError error) {
        ...
        u.a aVar = u.f17466b;
        eVar.resumeWith(u.b(v.a(new PurchasesException(error))));
    }
}
