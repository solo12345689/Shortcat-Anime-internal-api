...
public final class CarouselComponentViewKt$CarouselComponentView$5$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ CarouselComponentState $carouselState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CarouselComponentViewKt$CarouselComponentView$5$1(CarouselComponentState carouselComponentState) {
        super(2);
    ...
    public final e invoke(e applyIfNotNull, BorderStyle it) {
        ...
        return p.i(BorderKt.border(applyIfNotNull, it, this.$carouselState.getShape()), it.m457getWidthD9Ej5fM());
    }
}
