...
final class CarouselComponentViewKt$PagerIndicator$1$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ h2 $composeShape$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CarouselComponentViewKt$PagerIndicator$1$1(h2 h2Var) {
        super(2);
    ...
    public final e invoke(e applyIfNotNull, ShadowStyle it) {
        ...
        return ShadowKt.shadow(applyIfNotNull, it, CarouselComponentViewKt.PagerIndicator$lambda$12(this.$composeShape$delegate));
    }
}
