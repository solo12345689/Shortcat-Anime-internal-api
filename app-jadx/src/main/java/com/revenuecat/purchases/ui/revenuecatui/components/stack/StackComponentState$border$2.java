...
final class StackComponentState$border$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ StackComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    StackComponentState$border$2(StackComponentState stackComponentState) {
        super(0);
