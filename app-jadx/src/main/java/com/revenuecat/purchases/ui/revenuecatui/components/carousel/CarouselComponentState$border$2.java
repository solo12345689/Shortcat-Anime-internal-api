...
final class CarouselComponentState$border$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ CarouselComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CarouselComponentState$border$2(CarouselComponentState carouselComponentState) {
        super(0);
