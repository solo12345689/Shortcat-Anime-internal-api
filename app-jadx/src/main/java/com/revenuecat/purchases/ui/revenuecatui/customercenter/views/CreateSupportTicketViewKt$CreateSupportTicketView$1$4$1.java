...
public final class CreateSupportTicketViewKt$CreateSupportTicketView$1$4$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    static final class AnonymousClass2 extends AbstractC5506u implements InterfaceC5082a {
        ...
        AnonymousClass2(C0 c02, C0 c03) {
            super(0);
            this.$isSubmitting$delegate = c02;
            this.$hasError$delegate = c03;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CreateSupportTicketViewKt$CreateSupportTicketView$1$4$1(CreateSupportTicketData createSupportTicketData, C0 c02, C0 c03, C0 c04, C0 c05) {
        super(0);
        this.$data = createSupportTicketData;
        this.$isSubmitting$delegate = c02;
        this.$hasError$delegate = c03;
        this.$email$delegate = c04;
        this.$description$delegate = c05;
    }
