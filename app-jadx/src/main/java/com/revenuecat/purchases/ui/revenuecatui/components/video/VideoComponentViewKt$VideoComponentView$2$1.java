...
final class VideoComponentViewKt$VideoComponentView$2$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ h2 $composeShape$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    VideoComponentViewKt$VideoComponentView$2$1(h2 h2Var) {
        super(2);
        this.$composeShape$delegate = h2Var;
    }

    @Override // kotlin.jvm.functions.Function2
    public final androidx.compose.ui.e invoke(androidx.compose.ui.e applyIfNotNull, ShadowStyle it) {
        AbstractC5504s.h(applyIfNotNull, "$this$applyIfNotNull");
        AbstractC5504s.h(it, "it");
        return ShadowKt.shadow(applyIfNotNull, it, VideoComponentViewKt.VideoComponentView$lambda$3(this.$composeShape$delegate));
    }
}
