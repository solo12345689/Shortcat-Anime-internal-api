...
final class TabsComponentViewKt$TabsComponentView$4$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ TabsComponentState $tabsState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TabsComponentViewKt$TabsComponentView$4$1(TabsComponentState tabsComponentState) {
        super(2);
    ...
    public final e invoke(e applyIfNotNull, BorderStyle it) {
        ...
        return p.i(BorderKt.border(applyIfNotNull, it, this.$tabsState.getShape()), it.m457getWidthD9Ej5fM());
    }
}
