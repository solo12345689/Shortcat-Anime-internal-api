...
final class Template7Kt$AnimatedPackages$1$2 extends AbstractC5506u implements InterfaceC5096o {
    ...
    Template7Kt$AnimatedPackages$1$2(List<TemplateConfiguration.PackageInfo> list, PaywallState.Loaded.Legacy legacy, PaywallViewModel paywallViewModel, TemplateConfiguration.Colors colors) {
        super(3);
        this.$packages = list;
        this.$state = legacy;
    ...
    public final void invoke(InterfaceC6784e AnimatedVisibility, InterfaceC2425m interfaceC2425m, int i10) {
        ...
        if (AbstractC2454w.L()) {
            AbstractC2454w.U(469640179, i10, -1, "com.revenuecat.purchases.ui.revenuecatui.templates.AnimatedPackages.<anonymous>.<anonymous> (Template7.kt:475)");
        }
        ...
        interfaceC2425m.V(1488342084);
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            Template7Kt.SelectPackageButton(c1139j, legacy, (TemplateConfiguration.PackageInfo) it.next(), paywallViewModel, colors, interfaceC2425m, 6);
        }
        interfaceC2425m.O();
        interfaceC2425m.x();
        if (AbstractC2454w.L()) {
