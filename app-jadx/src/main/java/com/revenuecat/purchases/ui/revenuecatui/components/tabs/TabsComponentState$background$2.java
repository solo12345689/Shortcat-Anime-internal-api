...
final class TabsComponentState$background$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ TabsComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TabsComponentState$background$2(TabsComponentState tabsComponentState) {
        super(0);
