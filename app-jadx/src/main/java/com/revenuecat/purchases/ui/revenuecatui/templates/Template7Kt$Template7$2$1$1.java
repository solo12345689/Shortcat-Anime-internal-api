...
final class Template7Kt$Template7$2$1$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ C0 $selectedTier$delegate;
    final /* synthetic */ PaywallState.Loaded.Legacy $state;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    Template7Kt$Template7$2$1$1(PaywallState.Loaded.Legacy legacy, C0 c02) {
        super(1);
        this.$state = legacy;
