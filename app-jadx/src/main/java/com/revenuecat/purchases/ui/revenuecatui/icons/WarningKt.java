...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0006\"\u0018\u0010\u0001\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0014\u0010\u0005\u001a\u00020\u00008@X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004¨\u0006\u0006"}, d2 = {"Lx0/d;", "_warning", "Lx0/d;", "getWarning", "()Lx0/d;", "Warning", "revenuecatui_defaultsBc8Release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class WarningKt {
    private static C7032d _warning;

    public static final C7032d getWarning() {
        C7032d c7032d = _warning;
        if (c7032d != null) {
            AbstractC5504s.e(c7032d);
            return c7032d;
        }
        C7032d.a aVar = new C7032d.a("Filled.Warning", C5015h.n(24.0f), C5015h.n(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c7034f.g(1.0f, 21.0f);
        c7034f.a();
        c7034f.i(13.0f, 18.0f);
        c7034f.f(-2.0f);
        c7034f.p(-2.0f);
        c7034f.f(2.0f);
        c7034f.p(2.0f);
        c7034f.a();
        c7034f.i(13.0f, 14.0f);
        c7034f.f(-2.0f);
        c7034f.p(-4.0f);
        c7034f.f(2.0f);
        c7034f.p(4.0f);
