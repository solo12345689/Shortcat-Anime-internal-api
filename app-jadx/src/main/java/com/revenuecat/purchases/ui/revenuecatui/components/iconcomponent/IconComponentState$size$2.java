...
final class IconComponentState$size$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ IconComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    IconComponentState$size$2(IconComponentState iconComponentState) {
        super(0);
