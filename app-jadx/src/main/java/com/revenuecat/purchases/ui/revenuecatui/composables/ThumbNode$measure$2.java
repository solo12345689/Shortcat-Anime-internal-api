...
final class ThumbNode$measure$2 extends l implements Function2 {
    final /* synthetic */ float $offset;
    int label;
    final /* synthetic */ ThumbNode this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ThumbNode$measure$2(ThumbNode thumbNode, float f10, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o10, e eVar) {
        return ((ThumbNode$measure$2) create(o10, eVar)).invokeSuspend(L.f17438a);
    }
