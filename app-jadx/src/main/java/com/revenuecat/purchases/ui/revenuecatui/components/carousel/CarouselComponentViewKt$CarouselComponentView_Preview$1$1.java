...
final class CarouselComponentViewKt$CarouselComponentView_Preview$1$1 extends l implements Function2 {
    int label;

    CarouselComponentViewKt$CarouselComponentView_Preview$1$1(e eVar) {
        super(2, eVar);
    }

    @Override // kotlin.coroutines.jvm.internal.a
    public final e create(Object obj, e eVar) {
        return new CarouselComponentViewKt$CarouselComponentView_Preview$1$1(eVar);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((CarouselComponentViewKt$CarouselComponentView_Preview$1$1) create(paywallAction, eVar)).invokeSuspend(L.f17438a);
    }
