...
final class TimelineComponentViewKt$TimelineComponentView$2$5$1$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ TimelineComponentState $timelineState;
    final /* synthetic */ C5524f $titleRef;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TimelineComponentViewKt$TimelineComponentView$2$5$1$1(C5524f c5524f, TimelineComponentState timelineComponentState) {
        super(1);
    ...
    public final void invoke(C5523e constrainAs) {
        ...
        InterfaceC5540v.a(constrainAs.h(), this.$titleRef.b(), C5015h.n(this.$timelineState.getTextSpacing()), 0.0f, 4, null);
        InterfaceC5517E.a(constrainAs.g(), this.$titleRef.d(), 0.0f, 0.0f, 6, null);
