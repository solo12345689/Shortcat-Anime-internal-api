...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0006\"\u0018\u0010\u0001\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0014\u0010\u0005\u001a\u00020\u00008@X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004¨\u0006\u0006"}, d2 = {"Lx0/d;", "_arrowBack", "Lx0/d;", "getArrowBack", "()Lx0/d;", "ArrowBack", "revenuecatui_defaultsBc8Release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class ArrowBackKt {
    private static C7032d _arrowBack;

    public static final C7032d getArrowBack() {
        C7032d c7032d = _arrowBack;
        if (c7032d != null) {
            AbstractC5504s.e(c7032d);
            return c7032d;
        }
        C7032d.a aVar = new C7032d.a("AutoMirrored.Filled.ArrowBack", C5015h.n(24.0f), C5015h.n(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c7034f.i(20.0f, 11.0f);
        c7034f.e(7.83f);
        c7034f.h(5.59f, -5.59f);
        c7034f.g(12.0f, 4.0f);
        c7034f.h(-8.0f, 8.0f);
        c7034f.h(8.0f, 8.0f);
        c7034f.h(1.41f, -1.41f);
        c7034f.g(7.83f, 13.0f);
        c7034f.e(20.0f);
        c7034f.p(-2.0f);
        c7034f.a();
