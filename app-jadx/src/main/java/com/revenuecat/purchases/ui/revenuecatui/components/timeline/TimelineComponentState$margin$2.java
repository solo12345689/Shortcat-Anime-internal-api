...
final class TimelineComponentState$margin$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ TimelineComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TimelineComponentState$margin$2(TimelineComponentState timelineComponentState) {
        super(0);
