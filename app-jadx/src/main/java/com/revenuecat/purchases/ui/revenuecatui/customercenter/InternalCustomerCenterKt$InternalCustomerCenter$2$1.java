...
final class InternalCustomerCenterKt$InternalCustomerCenter$2$1 extends l implements Function2 {
    final /* synthetic */ h2 $state$delegate;
    final /* synthetic */ CustomerCenterViewModel $viewModel;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    InternalCustomerCenterKt$InternalCustomerCenter$2$1(CustomerCenterViewModel customerCenterViewModel, h2 h2Var, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o10, e eVar) {
        return ((InternalCustomerCenterKt$InternalCustomerCenter$2$1) create(o10, eVar)).invokeSuspend(L.f17438a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            if (InternalCustomerCenterKt.InternalCustomerCenter$lambda$1(this.$state$delegate) instanceof CustomerCenterState.NotLoaded) {
                ...
                this.label = 1;
                if (customerCenterViewModel.loadCustomerCenter(this) == objF) {
                    return objF;
                }
            }
        } else {
