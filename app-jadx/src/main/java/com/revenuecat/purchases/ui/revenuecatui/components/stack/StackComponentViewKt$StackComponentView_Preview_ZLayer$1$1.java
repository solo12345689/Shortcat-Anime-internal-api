...
final class StackComponentViewKt$StackComponentView_Preview_ZLayer$1$1 extends l implements Function2 {
    int label;

    StackComponentViewKt$StackComponentView_Preview_ZLayer$1$1(e eVar) {
        super(2, eVar);
    }

    @Override // kotlin.coroutines.jvm.internal.a
    public final e create(Object obj, e eVar) {
        return new StackComponentViewKt$StackComponentView_Preview_ZLayer$1$1(eVar);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((StackComponentViewKt$StackComponentView_Preview_ZLayer$1$1) create(paywallAction, eVar)).invokeSuspend(L.f17438a);
    }
