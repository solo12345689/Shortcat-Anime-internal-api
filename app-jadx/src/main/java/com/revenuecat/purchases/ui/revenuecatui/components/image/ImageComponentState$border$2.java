...
final class ImageComponentState$border$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ ImageComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ImageComponentState$border$2(ImageComponentState imageComponentState) {
        super(0);
