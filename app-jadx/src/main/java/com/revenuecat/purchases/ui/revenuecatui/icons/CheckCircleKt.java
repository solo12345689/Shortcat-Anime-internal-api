...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0006\"\u0018\u0010\u0001\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0014\u0010\u0005\u001a\u00020\u00008@X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004¨\u0006\u0006"}, d2 = {"Lx0/d;", "_checkCircle", "Lx0/d;", "getCheckCircle", "()Lx0/d;", "CheckCircle", "revenuecatui_defaultsBc8Release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class CheckCircleKt {
    private static C7032d _checkCircle;

    public static final C7032d getCheckCircle() {
        C7032d c7032d = _checkCircle;
        if (c7032d != null) {
            AbstractC5504s.e(c7032d);
            return c7032d;
        }
        C7032d.a aVar = new C7032d.a("Filled.CheckCircle", C5015h.n(24.0f), C5015h.n(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        c7034f.m(4.48f, 10.0f, 10.0f, 10.0f);
        c7034f.m(10.0f, -4.48f, 10.0f, -10.0f);
        c7034f.l(17.52f, 2.0f, 12.0f, 2.0f);
        c7034f.a();
        c7034f.i(10.0f, 17.0f);
        c7034f.h(-5.0f, -5.0f);
        c7034f.h(1.41f, -1.41f);
        c7034f.h(3.59f, 3.58f);
        c7034f.g(17.59f, 6.59f);
        c7034f.g(19.0f, 8.0f);
        c7034f.h(-9.0f, 9.0f);
        c7034f.a();
