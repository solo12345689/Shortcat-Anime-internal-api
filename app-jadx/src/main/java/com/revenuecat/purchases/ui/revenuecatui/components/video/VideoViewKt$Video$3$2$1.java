...
final class VideoViewKt$Video$3$2$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ String $key;
    final /* synthetic */ Map<String, VideoPlaybackState> $savedState;
    final /* synthetic */ C0 $videoView;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    VideoViewKt$Video$3$2$1(C0 c02, Map<String, VideoPlaybackState> map, String str) {
        super(1);
        this.$videoView = c02;
        this.$savedState = map;
        this.$key = str;
