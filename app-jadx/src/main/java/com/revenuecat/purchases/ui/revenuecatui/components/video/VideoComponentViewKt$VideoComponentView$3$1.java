...
final class VideoComponentViewKt$VideoComponentView$3$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ h2 $composeShape$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    VideoComponentViewKt$VideoComponentView$3$1(h2 h2Var) {
        super(2);
        this.$composeShape$delegate = h2Var;
    }

    @Override // kotlin.jvm.functions.Function2
    public final androidx.compose.ui.e invoke(androidx.compose.ui.e applyIfNotNull, BorderStyle it) {
        AbstractC5504s.h(applyIfNotNull, "$this$applyIfNotNull");
        AbstractC5504s.h(it, "it");
        return p.i(BorderKt.border(applyIfNotNull, it, VideoComponentViewKt.VideoComponentView$lambda$3(this.$composeShape$delegate)), it.m457getWidthD9Ej5fM());
    }
}
