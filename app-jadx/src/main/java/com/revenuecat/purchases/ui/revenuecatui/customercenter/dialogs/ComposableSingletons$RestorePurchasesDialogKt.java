...
public final class ComposableSingletons$RestorePurchasesDialogKt {
    ...
    public static Function2 f20lambda1 = i.b(375690679, false, ComposableSingletons$RestorePurchasesDialogKt$lambda1$1.INSTANCE);

    /* JADX INFO: renamed from: lambda-2, reason: not valid java name */
    public static Function2 f21lambda2 = i.b(246978940, false, ComposableSingletons$RestorePurchasesDialogKt$lambda2$1.INSTANCE);

    /* JADX INFO: renamed from: getLambda-1$revenuecatui_defaultsBc8Release, reason: not valid java name */
    public final Function2 m687getLambda1$revenuecatui_defaultsBc8Release() {
        return f20lambda1;
    }

    /* JADX INFO: renamed from: getLambda-2$revenuecatui_defaultsBc8Release, reason: not valid java name */
    public final Function2 m688getLambda2$revenuecatui_defaultsBc8Release() {
        return f21lambda2;
    }
}
