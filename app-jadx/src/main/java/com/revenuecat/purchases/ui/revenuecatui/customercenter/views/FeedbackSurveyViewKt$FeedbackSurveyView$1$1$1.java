...
public final class FeedbackSurveyViewKt$FeedbackSurveyView$1$1$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ FeedbackSurveyData $data;
    final /* synthetic */ C0 $loadingOption$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FeedbackSurveyViewKt$FeedbackSurveyView$1$1$1(FeedbackSurveyData feedbackSurveyData, C0 c02) {
        super(1);
        this.$data = feedbackSurveyData;
        this.$loadingOption$delegate = c02;
    }
