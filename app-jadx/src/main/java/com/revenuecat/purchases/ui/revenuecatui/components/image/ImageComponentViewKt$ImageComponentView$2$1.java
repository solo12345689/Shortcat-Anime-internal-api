...
public final class ImageComponentViewKt$ImageComponentView$2$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ h2 $composeShape$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ImageComponentViewKt$ImageComponentView$2$1(h2 h2Var) {
        super(2);
    ...
    public final e invoke(e applyIfNotNull, ShadowStyle it) {
        ...
        return ShadowKt.shadow(applyIfNotNull, it, ImageComponentViewKt.ImageComponentView$lambda$3(this.$composeShape$delegate));
    }
}
