...
final class StackComponentViewKt$MainStackComponent$stack$1$2$1$1$2$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ P $safeDrawingInsets;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    StackComponentViewKt$MainStackComponent$stack$1$2$1$1$2$1(P p10) {
        super(1);
    ...
    public final e invoke(e conditional) {
        ...
        return T.c(conditional, S.e(this.$safeDrawingInsets, V.f2072a.g()));
    }
}
