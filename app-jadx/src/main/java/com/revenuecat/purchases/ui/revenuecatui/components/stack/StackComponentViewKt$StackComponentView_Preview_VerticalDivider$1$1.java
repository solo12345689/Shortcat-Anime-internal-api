...
final class StackComponentViewKt$StackComponentView_Preview_VerticalDivider$1$1 extends l implements Function2 {
    int label;

    StackComponentViewKt$StackComponentView_Preview_VerticalDivider$1$1(e eVar) {
        super(2, eVar);
    }
    ...
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((StackComponentViewKt$StackComponentView_Preview_VerticalDivider$1$1) create(paywallAction, eVar)).invokeSuspend(L.f17438a);
    }
