...
final class Template4Kt$CheckmarkBox$1$1 extends AbstractC5506u implements InterfaceC5096o {
    ...
    public final void invoke(InterfaceC6784e AnimatedVisibility, InterfaceC2425m interfaceC2425m, int i10) {
        ...
        if (AbstractC2454w.L()) {
            AbstractC2454w.U(-2128395201, i10, -1, "com.revenuecat.purchases.ui.revenuecatui.templates.CheckmarkBox.<anonymous>.<anonymous> (Template4.kt:445)");
        }
        PaywallIconKt.m607PaywallIconFNF3uiM(PaywallIconName.CHECK_CIRCLE, null, this.$colors.m778getAccent10d7_KjU(), interfaceC2425m, 6, 2);
        if (AbstractC2454w.L()) {
            AbstractC2454w.T();
        }
    }
