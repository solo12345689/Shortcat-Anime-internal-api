...
final class VideoComponentState$fallbackImageUrls$2 extends AbstractC5506u implements InterfaceC5082a {
    final /* synthetic */ VideoComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    VideoComponentState$fallbackImageUrls$2(VideoComponentState videoComponentState) {
        super(0);
    ...
    public final ThemeImageUrls invoke() {
        ...
        if (fallbackSources != null) {
            return (ThemeImageUrls) fallbackSources.getOrDefault(LocaleId.m307boximpl(localeId), fallbackSources.getEntry().getValue());
        }
        return null;
    }
}
