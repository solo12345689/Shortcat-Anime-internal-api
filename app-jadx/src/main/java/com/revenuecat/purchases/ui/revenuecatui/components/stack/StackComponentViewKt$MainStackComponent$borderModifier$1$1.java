...
final class StackComponentViewKt$MainStackComponent$borderModifier$1$1 extends AbstractC5506u implements Function2 {
    final /* synthetic */ h2 $composeShape$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    StackComponentViewKt$MainStackComponent$borderModifier$1$1(h2 h2Var) {
        super(2);
    ...
    public final e invoke(e applyIfNotNull, BorderStyle it) {
        ...
        return p.i(BorderKt.border(applyIfNotNull, it, StackComponentViewKt.MainStackComponent$lambda$10(this.$composeShape$delegate)), it.m457getWidthD9Ej5fM());
    }
}
