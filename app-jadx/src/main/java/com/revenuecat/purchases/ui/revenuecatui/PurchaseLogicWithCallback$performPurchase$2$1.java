...
final class PurchaseLogicWithCallback$performPurchase$2$1 extends AbstractC5506u implements Function1 {
    final /* synthetic */ e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PurchaseLogicWithCallback$performPurchase$2$1(e eVar) {
        super(1);
