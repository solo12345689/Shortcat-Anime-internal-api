...
final class HorizontalStackKt$HorizontalStack$1$edgeSpacerIfNeeded$1 extends AbstractC5506u implements Function2 {
    ...
    HorizontalStackKt$HorizontalStack$1$edgeSpacerIfNeeded$1(HorizontalStackScopeImpl horizontalStackScopeImpl, Dimension.Horizontal horizontal, InterfaceC5096o interfaceC5096o) {
        super(2);
    ...
    public final void invoke(InterfaceC2425m interfaceC2425m, int i10) {
        ...
        if (AbstractC2454w.L()) {
            AbstractC2454w.U(-1884036483, i10, -1, "com.revenuecat.purchases.ui.revenuecatui.components.stack.HorizontalStack.<anonymous>.<anonymous> (HorizontalStack.kt:56)");
        }
