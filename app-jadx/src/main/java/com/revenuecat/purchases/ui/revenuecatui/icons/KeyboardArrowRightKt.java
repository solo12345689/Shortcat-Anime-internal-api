...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0006\"\u0018\u0010\u0001\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0014\u0010\u0005\u001a\u00020\u00008@X\u0080\u0004¢\u0006\u0006\u001a\u0004\b\u0003\u0010\u0004¨\u0006\u0006"}, d2 = {"Lx0/d;", "_keyboardArrowRight", "Lx0/d;", "getKeyboardArrowRight", "()Lx0/d;", "KeyboardArrowRight", "revenuecatui_defaultsBc8Release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class KeyboardArrowRightKt {
    private static C7032d _keyboardArrowRight;

    public static final C7032d getKeyboardArrowRight() {
        C7032d c7032d = _keyboardArrowRight;
        if (c7032d != null) {
            AbstractC5504s.e(c7032d);
            return c7032d;
        }
        C7032d.a aVar = new C7032d.a("AutoMirrored.Filled.KeyboardArrowRight", C5015h.n(24.0f), C5015h.n(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        c7034f.i(8.59f, 16.59f);
        c7034f.g(13.17f, 12.0f);
        c7034f.g(8.59f, 7.41f);
        c7034f.g(10.0f, 6.0f);
        c7034f.h(6.0f, 6.0f);
        c7034f.h(-6.0f, 6.0f);
