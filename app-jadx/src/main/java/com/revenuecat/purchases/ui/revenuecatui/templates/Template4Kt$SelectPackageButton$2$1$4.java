...
final class Template4Kt$SelectPackageButton$2$1$4 extends AbstractC5506u implements InterfaceC5096o {
    ...
    public final void invoke(I Button, InterfaceC2425m interfaceC2425m, int i10) {
        ...
        if (AbstractC2454w.L()) {
            AbstractC2454w.U(-1357178314, i10, -1, "com.revenuecat.purchases.ui.revenuecatui.templates.SelectPackageButton.<anonymous>.<anonymous>.<anonymous> (Template4.kt:325)");
        }
        Template4Kt.SelectPackageButtonContent(this.$packageInfo, this.$colors, interfaceC2425m, 0);
        if (AbstractC2454w.L()) {
            AbstractC2454w.T();
        }
    }
