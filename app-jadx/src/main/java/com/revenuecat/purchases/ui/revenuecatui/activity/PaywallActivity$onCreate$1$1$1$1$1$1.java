...
final class PaywallActivity$onCreate$1$1$1$1$1$1 extends l implements Function2 {
    final /* synthetic */ PaywallViewModel $viewModel;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PaywallActivity$onCreate$1$1$1$1$1$1(PaywallViewModel paywallViewModel, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o10, e eVar) {
        return ((PaywallActivity$onCreate$1$1$1$1$1$1) create(o10, eVar)).invokeSuspend(L.f17438a);
    }
