...
public final class PurchasesOrchestrator$syncAttributesAndOfferingsIfNeeded$$inlined$log$1 extends AbstractC5506u implements InterfaceC5082a {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(SyncAttributesAndOfferingsStrings.RATE_LIMIT_REACHED, Arrays.copyOf(new Object[]{Integer.valueOf(this.this$0.lastSyncAttributesAndOfferingsRateLimiter.getMaxCallsInPeriod()), Long.valueOf(Ef.a.y(this.this$0.lastSyncAttributesAndOfferingsRateLimiter.getPeriodSeconds()))}, 2));
