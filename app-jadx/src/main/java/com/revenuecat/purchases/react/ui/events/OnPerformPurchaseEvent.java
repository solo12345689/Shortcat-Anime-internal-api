...
public final class OnPerformPurchaseEvent extends PaywallEvent<OnPerformPurchaseEvent> {
    ...
    public PaywallEventName getPaywallEventName() {
        return PaywallEventName.ON_PERFORM_PURCHASE;
    }
}
