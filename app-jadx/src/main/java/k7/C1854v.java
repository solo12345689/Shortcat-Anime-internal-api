...
public class C1854v extends AbstractC3285c {
    public C1854v(BaseViewManager baseViewManager) {
    ...
    public void a(View view, String str, Object obj) {
        ...
        if (str.equals("unstable_forceActive")) {
            ((InterfaceC1856w) this.f37554a).setUnstable_forceActive(view, obj == null ? false : ((Boolean) obj).booleanValue());
        } else {
