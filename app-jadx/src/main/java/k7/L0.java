...
public interface L0 extends com.facebook.react.uimanager.A0 {
    ...
    void setPatternContentUnits(View view, int i10);

    void setPatternTransform(View view, ReadableArray readableArray);

    void setPatternUnits(View view, int i10);
