...
public abstract class b {
    ...
    private static final AbstractC2394b1 f14363a;
    ...
    static {
        ...
        try {
            ...
            AbstractC5504s.g(annotations, "getAnnotations(...)");
        ...
        if (abstractC2394b1J == null) {
            abstractC2394b1J = H.j(new InterfaceC5082a() { // from class: Q3.a
