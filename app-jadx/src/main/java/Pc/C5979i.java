...
public final class C5979i extends AbstractC5977g {
    ...
    /* synthetic */ class a extends AbstractC5502p implements Function1 {
        ...
        a() {
            super(1, C5853b.class, "<init>", "<init>(Lexpo/modules/kotlin/jni/JavaScriptTypedArray;)V", 0);
        }

        @Override // kotlin.jvm.functions.Function1
        /* JADX INFO: renamed from: j, reason: merged with bridge method [inline-methods] */
        public final C5853b invoke(JavaScriptTypedArray p02) {
            AbstractC5504s.h(p02, "p0");
            return new C5853b(p02);
        }
    }
