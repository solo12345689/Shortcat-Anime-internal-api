...
public abstract class c {
    ...
    private static final String[] f11633a = new String[0];
    ...
    public static String[] a(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f11633a;
        }
        ...
        return stringArray != null ? stringArray : f11633a;
    }
    ...
    public static void e(EditorInfo editorInfo, CharSequence charSequence, int i10) {
        ...
        if (c(editorInfo.inputType)) {
            ...
            i(editorInfo, charSequence, i13, i14);
        }
    }
