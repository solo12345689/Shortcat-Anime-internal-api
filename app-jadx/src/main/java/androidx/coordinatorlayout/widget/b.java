...
public abstract class b {
    ...
    private static final ThreadLocal f28728a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f28729b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f28728a;
        ...
        ThreadLocal threadLocal2 = f28729b;
