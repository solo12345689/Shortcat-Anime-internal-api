...
public final class n extends SpannableStringBuilder {
    ...
    private static class a implements TextWatcher, SpanWatcher {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final Object f29619a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final AtomicInteger f29620b = new AtomicInteger(0);
        ...
        final void a() {
            this.f29620b.incrementAndGet();
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f29619a).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f29619a).beforeTextChanged(charSequence, i10, i11, i12);
        }

        final void c() {
            this.f29620b.decrementAndGet();
        }

        @Override // android.text.SpanWatcher
        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f29620b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f29619a).onSpanAdded(spannable, obj, i10, i11);
            }
        }
  ...
  0x001e: PHI (r11v1 int) = (r11v0 int), (r11v3 int) binds: [B:8:0x0013, B:12:0x0019] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        public void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
            /*
                r8 = this;
                java.util.concurrent.atomic.AtomicInteger r0 = r8.f29620b
                int r0 = r0.get()
                if (r0 <= 0) goto Lf
                boolean r0 = r8.b(r10)
                if (r0 == 0) goto Lf
            ...
            L1e:
                ...
                r6 = r13
            L20:
                java.lang.Object r11 = r8.f29619a
                r1 = r11
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f29620b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f29619a).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f29619a).onTextChanged(charSequence, i10, i11, i12);
        }
    }

    n(Class cls, CharSequence charSequence) {
        super(charSequence);
        this.f29618b = new ArrayList();
        K1.f.h(cls, "watcherClass cannot be null");
        this.f29617a = cls;
    }

    private void b() {
        for (int i10 = 0; i10 < this.f29618b.size(); i10++) {
            ((a) this.f29618b.get(i10)).a();
        }
    }
    ...
    private void e() {
        for (int i10 = 0; i10 < this.f29618b.size(); i10++) {
            ((a) this.f29618b.get(i10)).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f29618b.size(); i10++) {
            a aVar = (a) this.f29618b.get(i10);
            if (aVar.f29619a == obj) {
                return aVar;
            }
        }
    ...
    public Object[] getSpans(int i10, int i11, Class cls) {
        ...
        for (int i12 = 0; i12 < aVarArr.length; i12++) {
            objArr[i12] = aVarArr[i12].f29619a;
        }
        return objArr;
    }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new n(this.f29617a, this, i10, i11);
    }
