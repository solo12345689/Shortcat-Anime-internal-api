...
public final class FragmentContainerView extends FrameLayout {
    ...
    public static final class a {
        ...
        public final WindowInsets a(View.OnApplyWindowInsetsListener onApplyWindowInsetsListener, View v10, WindowInsets insets) {
            AbstractC5504s.h(onApplyWindowInsetsListener, "onApplyWindowInsetsListener");
            ...
            AbstractC5504s.g(windowInsetsOnApplyWindowInsets, "onApplyWindowInsetsListe…lyWindowInsets(v, insets)");
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        ...
        AbstractC5504s.h(insets, "insets");
        L0 l0Z = L0.z(insets);
        AbstractC5504s.g(l0Z, "toWindowInsetsCompat(insets)");
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.applyWindowInsetsListener;
        if (onApplyWindowInsetsListener != null) {
            a aVar = a.f29739a;
            AbstractC5504s.e(onApplyWindowInsetsListener);
            l0W = L0.z(aVar.a(onApplyWindowInsetsListener, this, insets));
        } else {
            l0W = AbstractC2747a0.W(this, l0Z);
        }
        AbstractC5504s.g(l0W, "if (applyWindowInsetsLis…, insetsCompat)\n        }");
        if (!l0W.q()) {
            int childCount = getChildCount();
            for (int i10 = 0; i10 < childCount; i10++) {
                AbstractC2747a0.g(getChildAt(i10), l0W);
            }
        }
        return insets;
    }
    ...
    public final <F extends AbstractComponentCallbacksC2838q> F getFragment() {
        return (F) K.s0(this).p0(getId());
    }
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (attributeSet != null) {
            ...
            int[] FragmentContainerView = AbstractC4642c.f45792e;
            AbstractC5504s.g(FragmentContainerView, "FragmentContainerView");
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, FragmentContainerView, 0, 0);
            if (classAttribute == null) {
                classAttribute = typedArrayObtainStyledAttributes.getString(AbstractC4642c.f45793f);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, K fm) {
        ...
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(AbstractC4642c.f45793f) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(AbstractC4642c.f45794g);
        typedArrayObtainStyledAttributes.recycle();
        int id2 = getId();
        AbstractComponentCallbacksC2838q abstractComponentCallbacksC2838qP0 = fm.p0(id2);
        if (classAttribute != null && abstractComponentCallbacksC2838qP0 == null) {
            if (id2 == -1) {
                if (string != null) {
                    str = " with tag " + string;
                } else {
            ...
            AbstractComponentCallbacksC2838q abstractComponentCallbacksC2838qA = fm.B0().a(context.getClassLoader(), classAttribute);
            AbstractC5504s.g(abstractComponentCallbacksC2838qA, "fm.fragmentFactory.insta…ontext.classLoader, name)");
            abstractComponentCallbacksC2838qA.mFragmentId = id2;
            abstractComponentCallbacksC2838qA.mContainerId = id2;
            abstractComponentCallbacksC2838qA.mTag = string;
            abstractComponentCallbacksC2838qA.mFragmentManager = fm;
            abstractComponentCallbacksC2838qA.mHost = fm.D0();
            abstractComponentCallbacksC2838qA.onInflate(context, attrs, (Bundle) null);
            fm.s().v(true).d(this, abstractComponentCallbacksC2838qA, string).k();
        }
        fm.d1(this);
    }
}
